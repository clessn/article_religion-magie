...
raw_data <- haven::read_sav("_SharedFolder_article_religion-magie/Data/religiosity_historic/lake/general_social_survey_2015.sav")
...
variables <- c("importance", "participation", "religious_bin")
...
survey_id <- "general_social_survey_2015"
