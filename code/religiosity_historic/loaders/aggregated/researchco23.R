df <- readODS::read_ods("_SharedFolder_article_religion-magie/Data/religiosity_historic/warehouse/aggregated/researchco23.ods")
...
df_clean$survey_id <- "researchco23"

saveRDS(df_clean, "_SharedFolder_article_religion-magie/Data/religiosity_historic/warehouse/aggregated/researchco23.rds")
